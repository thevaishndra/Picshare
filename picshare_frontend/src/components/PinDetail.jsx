  ...
  const addComment = () => {
    if (comment) {
      ...
      client
        ...
        .commit() //after we insert something we need to commit
        .then(() => {
          fetchPinDetails();
          setComment("");
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          <div className="flex items-center justify-between ">
            <div className="flex gap-2 items-center">
              <a
                href={`${pinDetail.image?.asset?.url}?dl=`} //dl triggers download
                download
          ...
          <div className="flex flex-wrap mt-6 gap-3">
            ...
            <input className='flex-1 border-gray-100 outlin-none border-2 p-2 rounded-2xl focus:border-gray-300'
              type="text"
